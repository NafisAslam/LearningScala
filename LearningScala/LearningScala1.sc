object LearningScala1 {
  ...
  val Pi : Float = 3.14f                          //> Pi  : Float = 3.14
  val newValueOfPie = Pi*2                        //> newValueOfPie  : Float = 6.28
  println(f"This is the value of pi with with three decimal places of precision to the right :$newValueOfPie%.3f")
                                                  //> This is the value of pi with with three decimal places of precision to the 
                                                  //| right :6.280
